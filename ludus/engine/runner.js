...
'use strict';
/**
 * The Ludus runner — starts one classroom session.
 *
 *   node runner.js --pack <file-or-packId> [options]
 *
 * Options:
 *   --pack <p>        pack file path, or a packId to find in ~/ludus/packs
 ...
 *   --list            list packs in ~/ludus/packs and exit
 *
...
async function main() {
  ...
  console.log('\n' + '─'.repeat(64));
  console.log(`  LUDUS ${args.preview ? '· PREVIEW (dry-run) ' : ''}· ${shell.name}`);
