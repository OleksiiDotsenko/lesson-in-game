...
name: game-report
description: >-
  Turn the data a Ludus game captured into a one-page diagnostic the teacher can
...
under `${LUDUS_HOME:-$HOME/ludus}/sessions/`, and a copy of the one-pager into
`${LUDUS_HOME:-$HOME/ludus}/reports/`.

```bash
HOME_DIR="${LUDUS_HOME:-$HOME/ludus}"
